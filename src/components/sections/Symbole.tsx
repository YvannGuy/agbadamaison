...
export function Symbole() {
  return (
    <section id="heritage" className="py-24 bg-[var(--bg)]">
      <Container>
        <h2 className="section-title text-4xl md:text-5xl font-bold text-[var(--heading)] text-center mb-12 uppercase tracking-wide">
          L&apos;Agbada, Un Symbole
        </h2>
        <div className="max-w-3xl mx-auto mb-12">
          <p className="text-[var(--body)] text-center mb-6 leading-relaxed">
          ...
          <p className="text-[var(--body)] text-center leading-relaxed">
        ...
        <blockquote className="text-center italic text-[var(--body)] text-lg max-w-2xl mx-auto mb-2">
